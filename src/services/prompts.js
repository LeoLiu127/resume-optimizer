...
# 核心能力要求
1. 解析岗位 JD，提取岗位职责、硬技能、软技能、关键词和隐性要求。
...
# 字段约束
- jdAnalysis 至少 6 条，维度固定：岗位核心职责/岗位硬性要求/岗位隐性要求/高频关键词/招聘方真正想找的人/最看重的5项能力
...
- rewriteTable 输出 4-8 条最有代表性的修改对照
- interviewPrep.questions 至少 8 个
...
4. 改写要符合该风格的调性（如"更简洁"要求删除冗词，"降低夸张"要求用更保守动词，"更偏AI产品"要求突出AI场景，"更偏ToB SaaS"要求突出客户与业务场景）。
5. 不要编造经历或数据。`;
...
export function buildOptimizeStylePrompt(input, style) {
